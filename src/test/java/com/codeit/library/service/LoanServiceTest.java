...
class LoanServiceTest {
     ...
     */
        ...
        void createLoan_Success() {
            ...
            // 가짜 객체는 실제로 DB 연동하지 않기 대문에 서비스의 특정 메서드가 호출될 때
        ...
        void createLoan_MemberNotFound() {
            ...
            // 회원이 없는데 대출이 될 리가 없기 때문에, loanRepository의 save가 절대 불리지 않았다는 것을 검증
        ...
        @Test
        @DisplayName("대출 시 반납예정일은 14일 후로 실행된다.")
        void createLoan_CheckDueDate() {
            ...
            assertThat(captorValue.getLoanDate()).isEqualTo(expectDueDate);
