...
class BookControllerTest {
    ...
    class GetBook {
        ...
        void getAllBooks() throws Exception {
            ...
            List<BookResponse> books = List.of(
                    ...
                    new BookResponse(1L, "클린 클리닝", "깨끗", "456", 35000, null)
            );
            ...
            mockMvc.perform(get("/api/books")) // 가짜 요청 보내기
                    ...
                    .andExpect(jsonPath("$[1].title").value("클린 클리닝"));
    ...
    class CreateBook {
        ...
        void createBook_Success() throws Exception {
            ...
            mockMvc.perform(post("/api/books") // post 요청 보내기
                    .contentType(MediaType.APPLICATION_JSON) // JSON 데이터 보내기
                    .content(objectMapper.writeValueAsString(request)) // 자바 객체를 JSON 문자열로 변환해서 보내기
            )
