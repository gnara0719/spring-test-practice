...
class BookRepositoryTest {
    ...
    class search {
        ...
        void findByAuthor() {
            ...
            bookRepository.save(new Book("클린 아키텍처", "로버트 마틴", "112", 32000));
            bookRepository.save(new Book("클린 리펙토링", "마틴 파울러", "113", 35000));
        ...
        void findByISBN() {
            ...
            // when
            Optional<Book> found = bookRepository.findByIsbn("111");
    ...
    class ManualQuery {
        ...
        @Test
        @DisplayName("저자만 저장하여 검색한다.") // 가격만 지정, 조건을 지정하지 않으면 모든 책을 조회
